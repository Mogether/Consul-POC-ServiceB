...
import com.poc.serviceb.repository.ArtworkRepository;
import com.poc.serviceb.service.ArtworkService;
...
/**
 * REST controller for managing {@link com.poc.serviceb.domain.Artwork}.
 */
@RestController
@RequestMapping("/api")
public class ArtworkResource {
    ...
    private static final String ENTITY_NAME = "serviceBArtwork";
