...
@RestController
@RequestMapping("/api/service-b-kafka")
public class ServiceBKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ServiceBKafkaResource.class);
    ...
    public ServiceBKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
